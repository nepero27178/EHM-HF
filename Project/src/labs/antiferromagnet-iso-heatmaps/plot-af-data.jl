...
function PlotSided(
	...
	ax_H.yticks = ([2,4,4.93,6,8],["2","4","4.93","6","8"]) # ax_P.yticks.val
	# ylims!(ax_H,0.0,6.0)
	...
	elseif zVar=="tS"
		text!(ax_H,7.8,0.25,text="Soft shrinking",color=:white,align=(:right,:bottom))
	...
	contour!(ax_C,xx,yy,zz,colormap=colorschemes[:blacklight],labels=true,levels=6,labelsize=10)
