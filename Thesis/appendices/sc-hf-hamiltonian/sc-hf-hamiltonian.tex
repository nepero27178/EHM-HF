...
In this appendix, we derive the analytic expression of the HF hamiltonian for the SC phase, demonstrating all the results mentioned in Sec.~\ref{sec:sc-hf-hfps}. We start by discussing the SC phase on the conventional HM, and then generalise to the EHM.
...
\subsection{Effects of local Hartree terms: chemical potential renormalisation}
...
\subsection{Effects of local Cooper terms: isotropic pairing}
