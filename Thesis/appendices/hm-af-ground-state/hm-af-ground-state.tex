...
\begin{figure}
	...
	\caption{Sketch of the analytic expression for $m$. The left panel shows a family of coloured curves described by Eq.~\eqref{appeq:m-analytic}. The right panel shows a family of coloured curves described by Eq.~\eqref{appeq:m-approx}, only reasonable at $U \to 0$.}
