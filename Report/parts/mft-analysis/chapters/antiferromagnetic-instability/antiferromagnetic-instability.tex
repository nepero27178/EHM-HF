...
\end{multline}
In the above expressions the various contribution have been separated in ``density'' contributions and ``magnetization'' contributions. Let us deal with these separately. {\color{tabred}[Oh my God, the magnetization terms, they cancel out. That was the only thing I was pretty sure about. Jesus.]}
...
\begin{aligned}
	...
	\frac{\tilde{\epsilon}_{\mathbf{q}\sigma}}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
...
\begin{align}
	...
	\frac{\tilde{\epsilon}_{\mathbf{q}\sigma}}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		...
		\right) - f\left(
			\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right)
	\right] \label{eq:af-ud-self-consistency}
\end{align}
...
\[
	v_{\mathbf{q}\sigma} \equiv \langle
	\hat c_{\mathbf{q}\sigma}^\dagger
	\hat c_{\mathbf{q}+\bm{\pi}\sigma}
	\rangle
\]
and its $\gamma$-wave component, with $\gamma\in\lbrace s^*,d,p_x,p_y\rbrace$:
\[
\begin{aligned}
	v^{(\gamma)}_\sigma &= \frac{1}{L_x L_y} \sum_{\mathbf{q}\in\mathrm{BZ}} \varphi_\mathbf{q}^{(\gamma)}
	\langle
		\hat c_{\mathbf{q}\sigma}^\dagger
		\hat c_{\mathbf{q}+\bm{\pi}\sigma}
	\rangle \\
	...
	\rangle \\
	&= \frac{i}{2L_x L_y} \sum_{\mathbf{q}\in\mathrm{MBZ}} \varphi_\mathbf{q}^{(\gamma)}
	\frac{\Im\lbrace\tilde{\Delta}_{\mathbf{q}\sigma}\rbrace}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
			-\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right) - f\left(
			\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
...
\[
	v^{(s^*)}_\sigma, v^{(d)}_\sigma \in i\mathbb{R}
	\qquad
	v^{(p_x)}_\sigma, v^{(p_y)}_\sigma \in \mathbb{R}
\]
...
\begin{multline}
	...
	\rangle
	\hat c_{\mathbf{K}-\mathbf{k} \sigma}^\dagger \hat c_{\mathbf{K}-\mathbf{k}-\bm{\pi} \sigma} \\
	= -\sum_{\gamma,\sigma} V v^{(\gamma)}_\sigma
...
\[
	v^{(\gamma)}_\sigma \varphi_\mathbf{q}^{(\gamma)*} \in i\mathbb{R}
\]	
Moreover, since $\varphi_\mathbf{q}^{(\gamma)} = -\varphi_{\mathbf{q}+\bm{\pi}}^{(\gamma)}$, we have
\[
	v^{(\gamma)}_\sigma \varphi_{\mathbf{q}+\bm{\pi}}^{(\gamma)*} = \left(
	v^{(\gamma)}_\sigma \varphi_\mathbf{q}^{(\gamma)*}
	\right)^*
\]
Therefore
...
\begin{align}
	iv^{(s^*)}_\sigma &= -\frac{1}{2L_x L_y} \sum_{\mathbf{q}\in\mathrm{MBZ}} (\cos q_x + \cos q_y)
	\frac{\Im\lbrace\tilde{\Delta}_{\mathbf{q}\sigma}\rbrace}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
			-\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right) - f\left(
	...
	iv^{(d)}_\sigma &= -\frac{1}{2L_x L_y} \sum_{\mathbf{q}\in\mathrm{MBZ}} (\cos q_x - \cos q_y)
	\frac{\Im\lbrace\tilde{\Delta}_{\mathbf{q}\sigma}\rbrace}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
			-\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right) - f\left(
	...
	v^{(p_x)}_\sigma &= -\frac{1}{\sqrt{2}L_x L_y} \sum_{\mathbf{q}\in\mathrm{MBZ}} \sin q_x
	\frac{\Im\lbrace\tilde{\Delta}_{\mathbf{q}\sigma}\rbrace}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
			-\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right) - f\left(
	...
	v^{(p_y)}_\sigma &= -\frac{1}{\sqrt{2}L_x L_y} \sum_{\mathbf{q}\in\mathrm{MBZ}} \sin q_y
	\frac{\Im\lbrace\tilde{\Delta}_{\mathbf{q}\sigma}\rbrace}{\tilde{E}_{\mathbf{q}\sigma}} \left[
		f\left(
			-\tilde{E}_{\mathbf{q}\sigma};\beta,\tilde{\mu}
		\right) - f\left(
...
\end{align}
As we will discuss later in Sec.~\mref, not all these HFPs can coexist simultaneously. For now, let us move to the free energy density computation.
...
\[
	...
	\Big]
\]
Apply the decomposition of Eq.~\eqref{eq:coscos-symmetries-decomposition}, and we get
...
\[
	\tilde{\Delta}_{\mathbf{k}\sigma} = \Delta_\sigma + V \left[
		(-1)^{\delta_{\sigma=\uparrow}} 2mz + 
	\right]
\]

\subsection{Symmetry considerations and AF phase flavour}
