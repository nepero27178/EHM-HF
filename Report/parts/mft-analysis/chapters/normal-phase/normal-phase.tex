...
\section{Theoretical description of the ``normal'' phase}\label{sec:normal-phase-introduction}
...
\begin{equation}\label{eq:normal-U-contraction-energy}
...
\begin{equation}\label{eq:normal-V-contraction-energy}
