...
\]
A sketch of these angles and the pseudofield is given in Fig.~\ref{fig:af-bk-hm}.
...
\subsection{Features of the AF solution}
...
\begin{equation}\label{eq:af-V-fock-double-counting-int3}
	...
	\right]
\end{equation}
The new HFPs amplitudes contribute positively to contraction energy. The consequences of this fact will be discussed in Sec.~\ref{subsec:af-gap-energy}.
...
At half-filling and zero temperature we can extend that state to the new complexified gap. At zero temperature the AF ground-state for the EHM is identical to Eq.~\eqref{}
...
\end{equation}
The proof is identical to the one provided in Sec.~\ref{appsubsec:af-zero-T-half-filling-gs} for the HM, apart from renormalisations. Let $\ket{\mathbf{k}\sigma} \equiv \hat c_{\mathbf{k}\sigma}^\dagger \ket{\Omega_{\mathbf{k}\sigma}}$. Then we can write
\[
	\ket{\Psi} = \bigotimes_\sigma \bigotimes_{\mathbf{k}\in\mathrm{MBZ}} \left[
