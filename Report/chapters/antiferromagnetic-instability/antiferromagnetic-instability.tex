...
\end{enumerate}
This ends this short section and shows that also for the aAF phase all gap complexifiers actually vanish. Then, there is no need to distinguish two AF phases,
\[
...
{\color{tabred}[To be written: there is numeric strong evidence of no nematicity. Find a proof.]}