...
\[
	\mathrm{C}_4 \SSB \mathrm{C}_2
\]
The system is described by the five HFPs on the first row of Tab.~\ref{tab:saf-aaf-hfps} and their self-consistency equations of Tabs.~\ref{tab:af-ehm-ugamma-self-consistencies} and \ref{tab:af-ehm-vgamma-self-consistencies}.
...
\begin{enumerate}
	...
	\[
		...
		g(x)h(x) < 0
	\]
	for the same reasons. {\color{tabred}[Add sketch of $f'(x)$.]}
\end{enumerate}
