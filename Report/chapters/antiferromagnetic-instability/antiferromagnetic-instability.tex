...
\[
	...
	\delta = 0.0
\]
We set $\delta=0.0$. As we anticipated in Sec.~\ref{subsec:af-features} (and discuss in Sec.~\ref{appsubsec:af-instability}), any finite doping implies immediate disruption of commensurate antiferromagnetism, a consideration that makes any simulation at $\delta >0$ of low physical significance. Following this consideration, we omit data at finite $\delta \neq 0$.
