...
Finally, recall Tabs.~\ref{tab:HU-sel-rules} and \ref{tab:HV-sel-rules}: the relevant Wick's contractions are, for each sector,
\[
\begin{aligned}
	&\hat H_U 
...
\end{aligned}	
\]
We anticipate the role of all these in Tab.~\ref{tab:af-RWCs}.
...
\end{itemize}
The Ansatz of Eq.~\eqref{eq:af-mean-field-ansatz} is used in literature to describe antiferromagnetism in Hubbard lattice. Before moving to the EHM, we sketch in next section the theoretical description of commensurate antiferromagnetism in the HM.

\subsection{Antiferromagnetism in the HM}\label{subsec:af-hm}

Commensurate antiferromagnetism in conventional HM is widely studied \cite{fabrizio2022course}. FROM HERE
