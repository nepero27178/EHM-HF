...
\subsection{Hartree channel in the superconducting phase: analytical derivation}\label{subsec:sc-hartree-analytical}
...
\subsection{Fock channel in the superconducting phase: analytical derivation}\label{subsec:sc-fock-analytical}
...
\[
	...
	\rangle
\]
due to inversion symmetry the conclusion is identical to Eqns.~\eqref{eq:normal-V-fock-int5} and \eqref{eq:normal-bands-renormalization},
\[
...
The detailed treatment of $\hat H_U$ is discussed in Sec.~\ref{appsubsec:sc-cooper-channel}, in the context of conventional HM superconductivity. We hereby just sketch the most important results. First, similarly to the AF operator of Eq.~\eqref{eq:af-ehm-psi-def} let the Cooper fluctuations operator be
\begin{equation}\label{eq:sc-ehm-phi-def}
