...
Four phases can be distinguished: the normal state and three superconducting regions (pure $d$-wave, pure $s \oplus s^*$-wave, mixed). In Fig.~\ref{fig:sc-mix} we give a schematic depiction of how the plane $(\delta,V)$ divides in the four regions at $U=4,12$. The boundaries of the regions were computed setting an arbitrarily chosen threshold $\varepsilon$. \todo

The most dramatic consequence of symmetry mixing is the breaking of rotational symmetry. This is the subject of next section.
