...
\begin{align}
	\langle \hat \Psi_{\mathbf{k}\sigma}^\dagger \tau^x \hat \Psi_{\mathbf{k}\sigma} \rangle &= -\sin \normalfont(2\tilde{\theta}_{\mathbf{k}\sigma}) \sin \normalfont(2\tilde{\zeta}_{\mathbf{k}\sigma}) \langle \hat \Gamma_{\mathbf{k}\sigma}^\dagger \tau^z \hat \Gamma_{\mathbf{k}\sigma} \rangle \label{eq:sc-x-expectation-non-local}\\
	\langle \hat \Psi_{\mathbf{k}\sigma}^\dagger \tau^y \hat \Psi_{\mathbf{k}\sigma} \rangle &= -\sin \normalfont(2\tilde{\theta}_{\mathbf{k}\sigma}) \cos \normalfont(2\tilde{\zeta}_{\mathbf{k}\sigma}) \langle \hat \Gamma_{\mathbf{k}\sigma}^\dagger \tau^z \hat \Gamma_{\mathbf{k}\sigma} \rangle \label{eq:sc-y-expectation-non-local}\\
	\langle \hat \Psi_{\mathbf{k}\sigma}^\dagger \tau^z \hat \Psi_{\mathbf{k}\sigma} \rangle &= \cos \normalfont(2\tilde{\theta}_{\mathbf{k}\sigma}) \langle \hat \Gamma_{\mathbf{k}\sigma}^\dagger \tau^z \hat \Gamma_{\mathbf{k}\sigma} \rangle \label{eq:sc-z-expectation-non-local}
\end{align}
...
\begin{equation}\label{eq:sc-rot-z-expectation}
	...
	f\left(
	\tilde{E}_{\mathbf{k}\sigma};\beta,0
	\right) - f\left(
	-\tilde{E}_{\mathbf{k}\sigma};\beta,0
	\right)
	\right]
...
\begin{equation}\label{eq:sc-bogoliubov-angle-relations}
	...
	\quad
	\cos \normalfont(2\tilde{\theta}_{\mathbf{k}\sigma}) = \frac{\tilde{\xi}_{\mathbf{k}\sigma}}{\tilde{E}_{\mathbf{k}\sigma}}
\end{equation}
...
\end{aligned}
\]
extending the symmetry sum to $\gamma \in \lbrace s^*, p_x, p_y, d_{x^2-y^2} \rbrace$. We defined
\[
	w^{(\gamma)} \equiv \frac{1}{L_x L_y} \sum_\mathbf{q} \varphi_\mathbf{q}^{(\gamma)} w_\mathbf{q}
\]
...
{\color{tabblue}CONTINUE FROM HERE}
