...
Antiferromagnetism is established by taking advantage of the ``superexchange mechanism''. 
...
%\textbf{Scaletta:
%\begin{enumerate}
%	{\color{tabblue}\item Nel modello di Hubbard si può ottenere Mott localisation (caso semplice a due siti e soluzione in appendice)
...
%	\item Stato RVB
%	{\color{tabblue} \item AF ordering è rotto dal doping
