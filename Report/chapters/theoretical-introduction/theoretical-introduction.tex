...
\begin{equation}\label{eq:extended-hubbard-model}
	...
	t, U, V > 0
\end{equation}
commonly referred to as ``Extended Hubbard model'' (EHM). The non-local attraction $V$ is independent of site and spin indices. In this thesis, we study the insurgence of antiferromagnetism and superconductivity in the EHM within numerical Hartree-Fock methods.
