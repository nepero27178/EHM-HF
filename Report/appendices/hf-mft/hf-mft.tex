...
\begin{align}
	\hat H_U &= U \sum_i \hat n_{i\uparrow} \hat n_{i\downarrow} \label{appeq:mft-HU} \\
	&\simeq U \sum_i \Big(
...
\begin{align}
	\hat H_V &= -V \sum_{\ev{ij}} \sum_{\sigma,\sigma'} \hat n_{i\sigma} \hat n_{j\sigma'} \label{appeq:mft-HV} \\
