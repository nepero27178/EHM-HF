...
In this subsection we provide an analytic expression to compute $m$ self-consistently at half-filling. Multiply Eq.~\eqref{appeq:af-hm-m-self-consistency} on both sides by $U$. Since due to symmetry $\mu=0$, we have the finite-temperature self-consistent equation
\[
