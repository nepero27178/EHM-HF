...
\[
	...
	\right] - mU \sum_{\mathbf{k}\in\mathrm{MBZ}} (-1)^{\delta_{\sigma=\downarrow}} \left[
...
\begin{aligned}
	...
	&= \frac{\ev{\hat n_{\mathbf{r}\uparrow}} + \ev{\hat n_{\mathbf{r}\uparrow}}}{2} \left(
		\hat n_{\mathbf{r}\uparrow} + \hat n_{\mathbf{r}\downarrow}
	\right) - \frac{\ev{\hat n_{\mathbf{r}\uparrow}} - \ev{\hat n_{\mathbf{r}\uparrow}}}{2} \left(
		\hat n_{\mathbf{r}\uparrow} - \hat n_{\mathbf{r}\downarrow}
	\right)
\end{aligned}
\]
...
\[
	n \equiv \frac{\ev{\hat n_{\mathbf{r}\uparrow}} + \ev{\hat n_{\mathbf{r}\uparrow}}}{2}
	\qquad
	\text{is $\mathbf{r}$-independent}
\]
while the spin averaged unbalance has a two-sites periodicity
\[
	m \equiv (-1)^{x+y} \frac{\ev{\hat n_{\mathbf{r}\uparrow}} - \ev{\hat n_{\mathbf{r}\uparrow}}}{2}
	\qquad
	\text{is $\mathbf{r}$-independent}
\]
...
\begin{align}
	n &= \frac{1}{L_x L_y} \sum_\mathbf{r} \frac{\ev{\hat n_{\mathbf{r}\uparrow}} + \ev{\hat n_{\mathbf{r}\uparrow}}}{2} \label{appeq:af-hm-n-self-consistency-implicit}\\
	m &= \frac{1}{L_x L_y} \sum_\mathbf{r} (-1)^{x+y} \frac{\ev{\hat n_{\mathbf{r}\uparrow}} - \ev{\hat n_{\mathbf{r}\uparrow}}}{2} \label{appeq:af-hm-m-self-consistency-implicit}
\end{align}
