...
\begin{equation}\label{appeq:sc-hm-anticommutation-energy}
	E_{\mathrm{A}/t}^{(\mathrm{SC})} \equiv -\sum_{\mathbf{k}\in\mathrm{BZ}} \xi_\mathbf{k}
\end{equation}
...
\begin{align}
	...
	\right] \nonumber \\
	&= - \frac{1}{L_x L_y} \sum_{\mathbf{k}\in\mathrm{BZ}} \frac{\Delta_\mathbf{k}}{E_\mathbf{k}} \mathrm{Th}_\mathbf{k}^{(-)}[\beta] \label{appeq:sc-hm-ws-self-consistency-2}
\end{align}
